const raccoonData = {
    ...
    toronto: {
        ...
        inTech: "You're unkillable. Hiring freezes, layoffs, RTO mandates—none of it stops you. When faced with an obstacle or pointless bureaucracy, you find 0 or build - a workaround. You're constantly learning, not for clout but because it's *useful*. New language? You'll pick it up. Legacy system no one understands? You'll reverse-engineer it. You're three steps ahead of middle management, too valuable to cut, too clever to constrain. The bureaucrats keep trying to stop you, and you keep thriving anyway. You're the Toronto raccoon: pragmatic, resilient, impossible to defeat. You're not here to perform—you're here to *solve problems*. And spite is a powerful motivator."
    },
    stuck: {
        name: "Stuck Raccoon",
