const raccoonData = {
    ...
    melanie: {
        ...
        inTech: "Your GitHub contribution graph is <em>pristine</em>. You've got three side projects, you're active on socials, and you're giving conference talks. You're building in public, shipping constantly, hustling visibly. But here's the question: is it for you, or is it for the algorithm? The line between genuine passion and performance has blurred. You're Melanie on her trike, Piper with her paintbrush-talented, yes, but performing. The work has become content. The learning has become the personal brand. It's exhausting, you might be burnt out, but the green squares must stay green. The hustle is the identity now."
    },
    toronto: {
        name: "Toronto Raccoon",
        subtitle: "The Unkillable",
        iconic: "Toronto raccoons are <em>legendary</em>. They've defeated every \"raccoon-proof\" garbage bin the city designed. They're clever, adaptable, unstoppable. The city tries to outsmart them; the raccoons just learn faster. They thrive in an environment actively hostile to their existence.",
        inTech: "You're unkillable. Hiring freezes, layoffs, RTO mandates-none of it stops you. When faced with an obstacle or pointless bureaucracy, you find - or build - a workaround. You're constantly learning, not for clout but because it's <em>useful</em>. New language? You'll pick it up. Legacy system no one understands? You'll reverse-engineer it. You're three steps ahead of middle management, too valuable to cut, too clever to constrain. The bureaucrats keep trying to stop you, and you keep thriving anyway. You're the Toronto raccoon: pragmatic, resilient, impossible to defeat. You're not here to perform-you're here to <em>solve problems</em>. And spite is a powerful motivator."
    },
    stuck: {
        name: "Stuck Raccoon",
    ...
    alligator: {
        ...
        inTech: "Capitalism wants to eat you, but you've figured out how to ride it. You're a contractor making 2x salary with zero benefits. You're a consultant exploiting the \"efficiency era\" chaos. You're riding startup equity lottery tickets. You're surfing the AI hype wave while knowing it's probably a bubble. You're not trying to fix the system or fight it-you're exploiting its inefficiencies for your own gain. It's working. <em>For now.</em> One wrong move and you're lunch. One market shift, one contract ending, one alligator turning its head-and it's over. But what a ride. You're not secure, you're not stable, but you're making it work through pure audacity and opportunism. You're the raccoon on the alligator: precarious, unhinged, and somehow still afloat."
    }
};
